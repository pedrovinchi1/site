                ...
                <div className="text-left">
                  ...
                  <div className="flex">
                    ...
                    <button
                      ...
                      onClick={() => {
                        navigator.clipboard.writeText("00020126580014BR.GOV.BCB.PIX0136a629534e-7e14-43ff-af5f-4631f7a4524");
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <p className="text-sm text-yellow-800">
                        O pagamento será processado automaticamente. Após concluir a transferência, 
                        sua compra será confirmada em até 1 minuto.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div key={`${item.id}-${item.selectedSize}`} className="flex justify-between mb-4">
                <div className="flex items-center">
                  <div className="w-16 h-16 flex-shrink-0 rounded overflow-hidden mr-4">
                    <img
                      src={item.images.find(img => img.isDefault)?.url || item.images[0].url}
                      alt={item.name}
