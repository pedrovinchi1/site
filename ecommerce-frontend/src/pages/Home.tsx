  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const productsResponse = await axios.get(`${API_URL}/products/`, { params: { featured: true } });
      ...
      <div className="relative">
        ...
        <div className="relative min-h-screen flex items-center justify-center px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-white mb-8">Nascidos Para Representar</p>
      ...
      <div className="bg-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Explore nossas coleções exclusivas para expressar seu estilo único</p>
          </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Confira os produtos mais vendidos da nossa coleção</p>
          </div>
            ...
            {featuredProducts.map((product) => (
              <Link key={product.id} to={`/product/${product.id}`} className="group">
                <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="p-4">
                    <h3 className="text-lg font-semibold mb-2 group-hover:text-red-600 transition-colors">{product.name}</h3>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">@levelco</p>
          </div>
